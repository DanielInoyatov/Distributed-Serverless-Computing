...
public class LeaderElection {
    ...
    private void sendNotifications(){
        if(this.server.getPeerState()!=PeerServer.ServerState.LOOKING){//this makes sure that the server state is actually looking before submitting votes
                ...
                //If we did get a message...
                    ...
                    if(haveEnoughVotes(votes,currentVote)){
                        ...
                        while(endTime-startTime<finalizeWait) {
                            Message nextMsg = incomingMessages.poll(finalizeWait - (System.currentTimeMillis() - startTime), TimeUnit.MILLISECONDS);
    ...
    private Vote acceptElectionWinner(ElectionNotification n) {
        ...
        if(this.server.getPeerState()!=PeerServer.ServerState.LOOKING){
            ...
            incomingMessages.removeIf(msg -> msg.getMessageType() == Message.MessageType.ELECTION);
