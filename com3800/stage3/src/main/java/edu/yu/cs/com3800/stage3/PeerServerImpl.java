                ...
                switch (getPeerState()){
                    ...
                    case LEADING:
                        if(this.serverThread == null || this.serverThread instanceof JavaRunnerFollower){
                            this.serverThread= new RoundRobinLeader(peerIDtoAddress, this.outgoingMessages, this.incomingMessages, this.myAddress, this.myPort, this.logger);
                            this.setName("RoundRobinLeader-"+this.myPort);
                    ...
                    case FOLLOWING:
                        if(this.serverThread == null || this.serverThread instanceof RoundRobinLeader){
                            this.serverThread = new JavaRunnerFollower(this.outgoingMessages, this.incomingMessages, this.myAddress.getHostString(), this.myPort, this.peerIDtoAddress.get(this.getCurrentLeader().getProposedLeaderID()).getHostName(),this.peerIDtoAddress.get(this.getCurrentLeader().getProposedLeaderID()).getPort(), this.logger);
                            this.setName("JavaRunnerFollower-"+this.myPort);
                            this.serverThread.start();
