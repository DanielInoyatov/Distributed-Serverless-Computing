...
public class JavaRunnerFollower extends Thread implements LoggingServer {
    ...
    public JavaRunnerFollower(LinkedBlockingQueue<Message> outgoingMessagesTCP, LinkedBlockingQueue<Message> incomingMessagesTCP, String myAddress, int myPort, String leaderHost, int leaderPort) {
        ...
        try{
            this.tcpSender = new TCPMessageSender(this.outgoingMessagesTCP, this.myPort, this.leaderHost, this.leaderPort);
        ...
        while (!Thread.currentThread().isInterrupted()){
            ...
            try{
                ...
                if(message.getMessageType()== Message.MessageType.WORK){
                    ...
                    this.outgoingMessagesTCP.put(new Message(Message.MessageType.COMPLETED_WORK, result.getBytes(StandardCharsets.UTF_8), myAddress, myPort, this.leaderHost, this.leaderPort, message.getRequestID()));
                ...
                try {
                    ...
                    this.outgoingMessagesTCP.put(new Message(Message.MessageType.COMPLETED_WORK, exceptionMessage.getBytes(StandardCharsets.UTF_8), myAddress, myPort, this.leaderHost, this.leaderPort, requestID));
